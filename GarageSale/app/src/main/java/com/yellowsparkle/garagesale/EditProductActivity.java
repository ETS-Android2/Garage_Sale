    ...
    private void submitProductData() {
        mUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pName.isEmpty()) {
                    Toast.makeText(EditProductActivity.this, "Product name is empty", Toast.LENGTH_SHORT).show();
                    mDialog.cancel();
                    return;
                }
                if (pPrice.isEmpty()) {
                    Toast.makeText(EditProductActivity.this, "Invalid price", Toast.LENGTH_SHORT).show();
                    mDialog.cancel();
                    return;
                }
                ...
                if (pDescription.isEmpty()) {
                    Toast.makeText(EditProductActivity.this, "Product description is empty", Toast.LENGTH_SHORT).show();
                    mDialog.cancel();
                    return;
                }
    ...
    private void uploadUserData(String productKey, Map<String, Object> updateProductData) {
        FirebaseFirestore.getInstance().collection("Products").document(productKey).update(updateProductData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull @NotNull Exception e) {
                mDialog.cancel();
                Toast.makeText(EditProductActivity.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
            }
        });
    }
}